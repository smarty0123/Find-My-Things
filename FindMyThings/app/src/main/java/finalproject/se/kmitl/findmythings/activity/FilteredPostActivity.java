...
public class FilteredPostActivity extends AppCompatActivity {
    private android.support.v7.widget.Toolbar mToolbar = null;
                    ...
                    if (dataSnapshot.exists()) {
                        for (DataSnapshot child : dataSnapshot.getChildren()) {
                            if (child.getKey().toString().equals("displayname")) {
                                ...
                                Glide.with(FilteredPostActivity.this).load(Uri.parse(img)).into(profileImage);
                            }
        ...
        navigationView.setNavigationItemSelectedListener(new NavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.allPost:
                        Intent intent = new Intent(FilteredPostActivity.this, MainActivity.class);
                        ...
                        break;
                    case R.id.myPost:
                        Intent myPostIntent = new Intent(FilteredPostActivity.this, MyPostActivity.class);
                    ...
                    case R.id.accountSetting:
                        Intent settingIntent = new Intent(FilteredPostActivity.this, EditAccountActivity.class);
                    ...
                    case R.id.logout:
                        ...
                        startActivity(new Intent(FilteredPostActivity.this, LoginActivity.class));
                        finish();
                        item.setChecked(true);
                        drawerLayout.closeDrawers();
                        break;
    ...
    public void onBackPressed() {
        super.onBackPressed();
        startActivity(new Intent(FilteredPostActivity.this, MainActivity.class));
        finish();
    }
}
